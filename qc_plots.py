...
def plot_methylation(input, outprefix):
    ...
    #plt.grid(True)
    plt.tight_layout()
    plt.savefig(outprefix + '.MT_methylation_by_pos.png', dpi=150)
    plt.show()
    ...
    plt.tight_layout()
    #plt.xticks([])
    plt.savefig(outprefix + '.MT_methylation_by_site.png', dpi=150)
    plt.show()
    ...
    #plt.grid(True)
    plt.tight_layout()
    plt.savefig(outprefix + '.MT_methylation_freq_histogram.png', dpi=150)
    plt.show()
